 ...
 *
 * The `tickets` field is marked with {@link JsonIgnore} to prevent it from being serialised into JSON.
 *
...
public class Client extends User {
     ...
     * This field is ignored during JSON serialisation to avoid circular references.
     */
    @OneToMany(mappedBy = "client")
    @JsonIgnore
